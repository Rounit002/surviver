...
export default function HowItWorksPage() {
  return <article className="shell max-w-2xl py-10"><p className="label">Behind the standings</p><h1 className="mt-3 text-3xl font-semibold">Curiosity is the score.</h1><p className="text-subtle mt-4 text-sm leading-7">The board favors underexposed products. Every visit that follows a qualified view updates a product’s Interest Rate — position cannot be bought.</p>
    ...
    <h2 className="text-xl font-semibold">The standard 35-product bracket</h2><p className="text-subtle mt-3 text-sm leading-6">A season starts only after all 35 entries are paid and approved. Smaller lineups use an adjusted bracket. Every round posts its elimination count and deadline.</p>
